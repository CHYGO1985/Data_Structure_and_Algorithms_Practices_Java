...
public class MiniTimeDifferenc {
	// round 1: 3.5 hours, solved, but the solution is not great, method 1 sometimes generate TLE
    // method 2: change string that contains time to array
    // method 2 can use a linkedlist then sort to solve the problme as well, save space but spend more time
