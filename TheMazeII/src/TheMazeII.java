...
public class TheMazeII {
    ...
    public static int shortestDistance(int[][] maze, int[] start, int[] destination) {
        ...
        return dfs(maze, status, start, destination, 1) == true ? status[destination[0]][destination[1]]: -1;
    }
    
    private static boolean dfs(int[][] maze, int[][] status, int[] start, int[] des, int length) {
    	...
    	*/
    	...
    	// verison 2 --> refactoring of version 1
	...
	public static void main(String[] args) {
		...
		int[] e = {1,0};
		*/
	    int shortest = shortestDistance(map, s, e);
